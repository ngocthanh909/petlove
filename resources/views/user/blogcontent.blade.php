            ...
            <div class="row">
                <div class="col pl-0 pr-0">
                    ...
                    <div class="blog-ads-wrapper">
                        <h5>Theo dõi Petlove Blogs để cập nhật những bài viết hấp dẫn</h5><a href="#"> <img src="{{ asset('frontend/images/—Pngtree—pet dog red dogs_1821721.png') }}" style="width: 100%; height: auto;"> </a>
                    </div>
                </div>
            </div>
        </div>
